...
• It needs to have an area where it can show the content of a file.
  Let you edit it.
• Create a menu called About that displays an about box containing
  the names of the authors of the app.
...
def run_about():
    messagebox.showinfo(title="About", message="This simple \
text editor was created as a solution for\
